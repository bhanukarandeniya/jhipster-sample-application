...
export class PhysicianComponent implements OnInit {
  ...
  trackId(index: number, item: IPhysician): number {
    return item.id!;
  }

  delete(physician: IPhysician): void {
    const modalRef = this.modalService.open(PhysicianDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.physician = physician;
  ...
  protected onSuccess(data: IPhysician[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
